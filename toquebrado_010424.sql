...
-- Started on 2024-04-01 20:09:23 -03
...
--
-- TOC entry 3404 (class 1262 OID 57421)
...
--
-- TOC entry 235 (class 1255 OID 57476)
...
--
-- TOC entry 236 (class 1255 OID 57480)
...
--
-- TOC entry 234 (class 1255 OID 57479)
...
--
-- TOC entry 239 (class 1255 OID 57501)
...
--
-- TOC entry 219 (class 1255 OID 57816)
-- Name: fisioterapeuta_que_n_atendeu(date, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fisioterapeuta_que_n_atendeu(data_inicioaux date, data_fimaux date) RETURNS TABLE(nome_aux character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
	return query select nome as nome_aux from fisioterapeuta where id not in 
	(select fisioterapeuta_id from atendimento where data_hora_inicio between 
	data_inicioAux and data_fimAux);
end;
$$;


ALTER FUNCTION public.fisioterapeuta_que_n_atendeu(data_inicioaux date, data_fimaux date) OWNER TO postgres;
...
--
-- TOC entry 241 (class 1255 OID 57834)
-- Name: media_notas_fisioterapeutas(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.media_notas_fisioterapeutas() RETURNS TABLE(fisioterapeuta_idaux integer, nome character varying, media numeric)
    LANGUAGE plpgsql
    AS $$
begin
	return query select fisioterapeuta.id, fisioterapeuta.nome, cast(avg(nota) as numeric(8,2)) as media from fisioterapeuta inner join atendimento on
	(fisioterapeuta.id = atendimento.fisioterapeuta_id) group by fisioterapeuta.id, fisioterapeuta.nome;

end;
$$;


ALTER FUNCTION public.media_notas_fisioterapeutas() OWNER TO postgres;

--
-- TOC entry 238 (class 1255 OID 57497)
...
--
-- TOC entry 237 (class 1255 OID 57481)
...
--
-- TOC entry 240 (class 1255 OID 57831)
-- Name: novo_atendimento(integer, integer, money, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.novo_atendimento(paciente_idaux integer, fisioterapeuta_idaux integer, valor_consultaaux money, data_hora_inicioaux timestamp with time zone) RETURNS void
    LANGUAGE plpgsql
    AS $$
declare 
	valor_por_horaAux money;
begin
	select valor_por_hora from fisioterapeuta where id = fisioterapeuta_idAux into valor_por_horaAux;
	raise notice '%', valor_por_horaAux;
	insert into atendimento (paciente_id, fisioterapeuta_id, valor_consulta, data_hora_inicio, data_hora_fim, valor_por_hora_fisioterapeuta)
	values (paciente_idAux, fisioterapeuta_idAux, valor_consultaAux, data_hora_inicioAux, data_hora_inicioAux + interval '2 hours', valor_por_horaAux);
end;
$$;


ALTER FUNCTION public.novo_atendimento(paciente_idaux integer, fisioterapeuta_idaux integer, valor_consultaaux money, data_hora_inicioaux timestamp with time zone) OWNER TO postgres;
...
--
-- TOC entry 242 (class 1255 OID 57838)
-- Name: salario_mensal(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.salario_mensal(fisioterapeuta_idaux integer, mesaux integer, anoaux integer) RETURNS money
    LANGUAGE plpgsql
    AS $$
declare 
	salario money;
begin
	select sum(transforma_para_horas(data_hora_fim - data_hora_inicio)*valor_por_hora_fisioterapeuta)
	from atendimento
	where extract(month from data_hora_inicio) = mesAux and extract(year from data_hora_inicio) = anoAux
group by fisioterapeuta_id having fisioterapeuta_id = fisioterapeuta_idAux into salario;
	return salario;
end;
$$;


ALTER FUNCTION public.salario_mensal(fisioterapeuta_idaux integer, mesaux integer, anoaux integer) OWNER TO postgres;
...
--
-- TOC entry 3235 (class 2604 OID 57453)
...
--
-- TOC entry 3238 (class 2604 OID 57454)
...
--
-- TOC entry 3240 (class 2604 OID 57455)
...
--
-- TOC entry 3393 (class 0 OID 57430)
-- Dependencies: 209
...
INSERT INTO public.atendimento VALUES (7, 1, 1, '2024-04-01 19:33:35.777513-03', '2024-04-01 19:33:35.777513-03', NULL, NULL, 'R$ 100,00', NULL);
INSERT INTO public.atendimento VALUES (8, 1, 1, '2024-04-01 19:33:51.962889-03', '2024-04-01 21:33:51.962889-03', NULL, NULL, 'R$ 100,00', NULL);
INSERT INTO public.atendimento VALUES (9, 1, 1, '2024-04-01 19:39:29.656929-03', '2024-04-01 21:39:29.656929-03', NULL, NULL, 'R$ 100,00', 'R$ 100,00');
INSERT INTO public.atendimento VALUES (10, 1, 1, '2024-04-01 19:40:36.742635-03', '2024-04-01 21:40:36.742635-03', NULL, NULL, 'R$ 100,00', 'R$ 100,00');
INSERT INTO public.atendimento VALUES (11, 1, 1, '2024-04-01 19:41:02.72781-03', '2024-04-01 21:41:02.72781-03', NULL, NULL, 'R$ 100,00', 'R$ 100,00');
INSERT INTO public.atendimento VALUES (14, 4, 1, '2024-04-01 19:42:03.218743-03', '2024-04-01 21:42:03.218743-03', NULL, NULL, 'R$ 150,00', 'R$ 150,00');
INSERT INTO public.atendimento VALUES (15, 4, 1, '2024-04-01 19:42:54.034615-03', '2024-04-01 21:42:54.034615-03', NULL, NULL, 'R$ 150,00', 'R$ 150,00');


--
-- TOC entry 3395 (class 0 OID 57439)
-- Dependencies: 211
...
--
-- TOC entry 3397 (class 0 OID 57446)
-- Dependencies: 213
...
SELECT pg_catalog.setval('public.atendimento_id_seq', 15, true);
...
--
-- TOC entry 3243 (class 2606 OID 57457)
...
--
-- TOC entry 3245 (class 2606 OID 57459)
...
--
-- TOC entry 3247 (class 2606 OID 57461)
...
--
-- TOC entry 3249 (class 2606 OID 57463)
...
--
-- TOC entry 3251 (class 2606 OID 57465)
...
--
-- TOC entry 3252 (class 2606 OID 57466)
...
--
-- TOC entry 3253 (class 2606 OID 57471)
...
-- Completed on 2024-04-01 20:09:23 -03
